...
public class WoodenStinger extends AbstractArrow {
    public Vec2 groundedOffset;

    public WoodenStinger(EntityType<? extends AbstractArrow> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setBaseDamage(0.75);
    }

    public WoodenStinger(LivingEntity shooter, Level level) {
