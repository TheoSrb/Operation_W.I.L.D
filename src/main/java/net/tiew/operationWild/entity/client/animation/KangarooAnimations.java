...
public class KangarooAnimations {
	...
	public static final AnimationDefinition ATTACK_STRIKE_3 = AnimationDefinition.Builder.withLength(1.75F)
		...
		.addAnimation("neck", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.4583F, KeyframeAnimations.degreeVec(17.5F, 0.0F, -2.5F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.75F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("neck", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.625F, KeyframeAnimations.degreeVec(-23.195F, -32.1717F, 14.3107F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.75F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			...
			new Keyframe(1.4583F, KeyframeAnimations.posVec(9.0F, 4.0F, -12.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.5417F, KeyframeAnimations.posVec(9.0F, 2.0F, -12.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.625F, KeyframeAnimations.posVec(9.0F, 7.0F, -12.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.SCALE, 
			...
			new Keyframe(1.2917F, KeyframeAnimations.scaleVec(1.1667F, 2.2667F, 1.1667F), AnimationChannel.Interpolations.CATMULLROM),
			...
			new Keyframe(1.625F, KeyframeAnimations.scaleVec(1.3984F, 1.6984F, 1.3984F), AnimationChannel.Interpolations.CATMULLROM),
