...
public class TranquilizerArrowModel extends EntityModel<TranquilizerArrow> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(OperationWild.MOD_ID, "tranquilizer_arrow"), "main");
    private final ModelPart back;
    private final ModelPart cross_1;
    private final ModelPart cross_2;

    public TranquilizerArrowModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(TranquilizerArrow entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
