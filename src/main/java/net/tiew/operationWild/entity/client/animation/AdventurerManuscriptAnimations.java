    ...
    public static final AnimationDefinition NEXT = AnimationDefinition.Builder.withLength(0.56f)
            ...
            .addAnimation("page",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            new Keyframe(0f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.CATMULLROM),
                            new Keyframe(0.48f, KeyframeAnimations.degreeVec(0f, 150f, 0f),
                                    AnimationChannel.Interpolations.CATMULLROM),
                            new Keyframe(0.55f, KeyframeAnimations.degreeVec(0f, 170f, 0f),
                                    AnimationChannel.Interpolations.CATMULLROM),
                            new Keyframe(0.56f, KeyframeAnimations.degreeVec(0f, 359.99999f, 0f),
                                    AnimationChannel.Interpolations.CATMULLROM)))
            .addAnimation("page",
                    new AnimationChannel(AnimationChannel.Targets.SCALE,
                            ...
                            new Keyframe(0.52f, KeyframeAnimations.scaleVec(1f, 1f, 1f),
                                    AnimationChannel.Interpolations.CATMULLROM),
                            new Keyframe(0.54f, KeyframeAnimations.scaleVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.CATMULLROM),
