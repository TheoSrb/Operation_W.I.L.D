...
public class CrocodileSkins extends RenderLayer<CrocodileEntity, CrocodileModel<CrocodileEntity>> {
    ...
    public CrocodileSkins(CrocodileRenderer crocodileRenderer) {
        super(crocodileRenderer);
    }

    @Override
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, CrocodileEntity kodiak, float v, float v1, float v2, float v3, float v4, float v5) {
        if (kodiak.getVariant() == CrocodileVariant.SKIN_GOLD) {
