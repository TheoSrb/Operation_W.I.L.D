...
public class ElephantSkin {
    ...
    /** For BASE/REPLACEMENT: main texture. For OVERLAY: base elephant texture shown on base model. */
    ...
    protected ElephantSkin(Mode mode, ResourceLocation texture, @Nullable ResourceLocation overlayTexture,
    ...
    public static ElephantSkin base(ResourceLocation texture) {
        return new ElephantSkin(Mode.BASE, texture, null, null, null);
    }

    /** Overlay skin: renders the base elephant normally, then renders an additional model layer on top. */
    public static ElephantSkin overlay(ResourceLocation baseTexture, ResourceLocation overlayTexture,
                                       ModelLayerLocation overlayModelLayer, Supplier<LayerDefinition> layerDef) {
        return new ElephantSkin(Mode.OVERLAY, baseTexture, overlayTexture, overlayModelLayer, layerDef);
    }

    /** Replacement skin: replaces model and texture entirely. */
    public static ElephantSkin replacement(ResourceLocation texture, ModelLayerLocation modelLayer,
                                           Supplier<LayerDefinition> layerDef) {
        return new ElephantSkin(Mode.REPLACEMENT, texture, null, modelLayer, layerDef);
    }
    ...
    protected static void renderGlow(PoseStack poseStack, MultiBufferSource bufferSource,
                                     ResourceLocation texture, ElephantModel<ElephantEntity> model) {
    ...
    protected static void renderCutout(PoseStack poseStack, MultiBufferSource bufferSource,
                                       ...
                                       ElephantModel<ElephantEntity> model) {
