...
public class SeaBugShard1Model<T extends SeaBugShard1Entity> extends HierarchicalModel<T> {
    ...
    public SeaBugShard1Model(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition main_cage = ALL.addOrReplaceChild("main_cage", CubeListBuilder.create().texOffs(0, 0).addBox(-11.0F, -5.0F, -19.0F, 22.0F, 16.0F, 37.0F, new CubeDeformation(0.0F))
				...
				.texOffs(33, 122).addBox(-2.0F, 1.0F, -25.025F, 4.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
    ...
    @Override
    public void setupAnim(SeaBugShard1Entity seabug, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
