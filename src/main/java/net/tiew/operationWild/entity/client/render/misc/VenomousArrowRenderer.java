...
public class VenomousArrowRenderer extends EntityRenderer<VenomousArrow> {
    ...
    public VenomousArrowRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new VenomousArrowModel(context.bakeLayer(VenomousArrowModel.LAYER_LOCATION));
    }

    @Override
    public void render(VenomousArrow pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        pPoseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(VenomousArrow venomousArrow) {
        return ResourceLocation.fromNamespaceAndPath(OperationWild.MOD_ID, "textures/entity/venomous_arrow/venomous_arrow.png");
    }
