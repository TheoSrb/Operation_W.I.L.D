...
public class WoodenStingerModel extends EntityModel<WoodenStinger> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(OperationWild.MOD_ID, "wooden_stinger"), "main");
    private final ModelPart root;


    public WoodenStingerModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(WoodenStinger entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
