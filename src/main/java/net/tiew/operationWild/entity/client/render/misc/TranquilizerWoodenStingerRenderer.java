...
import net.tiew.operationWild.entity.client.model.misc.TranquilizerWoodenStingerModel;
import net.tiew.operationWild.entity.custom.misc.TranquilizerWoodenStinger;

public class TranquilizerWoodenStingerRenderer extends EntityRenderer<TranquilizerWoodenStinger> {
    private TranquilizerWoodenStingerModel model;

    public TranquilizerWoodenStingerRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new TranquilizerWoodenStingerModel(context.bakeLayer(TranquilizerWoodenStingerModel.LAYER_LOCATION));
    }

    @Override
    public void render(TranquilizerWoodenStinger pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        pPoseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(TranquilizerWoodenStinger woodenStinger) {
        return ResourceLocation.fromNamespaceAndPath(OperationWild.MOD_ID, "textures/entity/tranquilizer_wooden_stinger/tranquilizer_wooden_stinger.png");
    }
