...
public class CrocodileSkin {
    ...
    protected CrocodileSkin(Mode mode, ResourceLocation texture, @Nullable ResourceLocation overlayTexture,
    ...
    public static CrocodileSkin base(ResourceLocation texture) {
        return new CrocodileSkin(Mode.BASE, texture, null, null, null);
    }

    /** Overlay skin: renders the base croc normally, then renders an additional model layer on top. */
    public static CrocodileSkin overlay(ResourceLocation baseTexture, ResourceLocation overlayTexture,
                                        ModelLayerLocation overlayModelLayer, Supplier<LayerDefinition> layerDef) {
        return new CrocodileSkin(Mode.OVERLAY, baseTexture, overlayTexture, overlayModelLayer, layerDef);
    }

    /** Replacement skin: replaces model and texture entirely. */
    public static CrocodileSkin replacement(ResourceLocation texture, ModelLayerLocation modelLayer,
                                            Supplier<LayerDefinition> layerDef) {
        return new CrocodileSkin(Mode.REPLACEMENT, texture, null, modelLayer, layerDef);
    }
    ...
    protected static void renderGlow(PoseStack poseStack, MultiBufferSource bufferSource,
                                     ResourceLocation texture, CrocodileModel<CrocodileEntity> model) {
    ...
    protected static void renderCutout(PoseStack poseStack, MultiBufferSource bufferSource,
                                       ...
                                       CrocodileModel<CrocodileEntity> model) {
