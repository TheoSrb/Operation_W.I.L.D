...
public class OWEntityRegistry {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<WalrusEntity>> WALRUS = ENTITY_TYPES.register("walrus", () -> EntityType.Builder.<WalrusEntity>of((type, world) -> new WalrusEntity(type, world, 1.0f, 4500, 1), MobCategory.CREATURE).sized(2.1f, 1.7f).build("walrus"));
