...
public class OWEntityRegistry {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<HyenaEntity>> HYENA = ENTITY_TYPES.register("hyena", () -> EntityType.Builder.<HyenaEntity>of((type, world) -> new HyenaEntity(type, world, 1.0f, 1750, 3), MobCategory.CREATURE).sized(1.1f, 1.1f).build("hyena"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<JellyfishEntity>> JELLYFISH = ENTITY_TYPES.register("jellyfish", () -> EntityType.Builder.<JellyfishEntity>of((type, world) -> new JellyfishEntity(type, world, 0.95f, 1250, 15), MobCategory.WATER_CREATURE).sized(0.9f, 1.7f).build("jellyfish"));
