...
public class OWEntityRegistry {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<CrocodileTailPart>> CROCODILE_TAIL_PART =
            ENTITY_TYPES.register("crocodile_tail_part", () -> EntityType.Builder
                    .<CrocodileTailPart>of(CrocodileTailPart::new, MobCategory.MISC)
                    .noSave()
                    .noSummon()
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ThrownRockEntity>> THROWN_ROCK = ENTITY_TYPES.register("thrown_rock", () -> EntityType.Builder.<ThrownRockEntity>of(ThrownRockEntity::new, MobCategory.MISC).sized(1.0f, 1.0f).clientTrackingRange(10).updateInterval(1).build("thrown_rock"));
