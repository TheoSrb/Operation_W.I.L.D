...
public class OWEntityRegistry {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ElephantEntity>> ELEPHANT = ENTITY_TYPES.register("elephant", () -> EntityType.Builder.<ElephantEntity>of((type, world) -> new ElephantEntity(type, world, 1f, 7000, 5, true), MobCategory.CREATURE).sized(2.5f, 3f).build("elephant"));
