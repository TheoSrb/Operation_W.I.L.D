...
public class KodiakRubsAgainstTreeGoal extends Goal {
    ...
    public boolean canContinueToUse() {
        ...
        return distance > 1.5 && !kodiak.isCatchingSalmon() && !kodiak.isTame() && !kodiak.isHungry();
    }
    ...
    public boolean canUse() {
        return kodiak.getRandom().nextInt((int) (200 / attractionFrequencyMultiplier)) == 0 &&
                ...
                !kodiak.isNapping() && !kodiak.isSearchingInsideChest && !kodiak.isInWater() && !kodiak.isCatchingSalmon() && !kodiak.isTame() && !kodiak.isHungry();
    }
