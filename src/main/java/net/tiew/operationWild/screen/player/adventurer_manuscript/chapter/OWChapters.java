...
public class OWChapters extends OWChapter {
    ...
    public static class BoaChapter extends OWChapter {
        public static void render(int x, int y, float scale, float alpha, int page) {
            ...
            Component text_6 = Component.translatable("adventurer_manuscript.entity.boa.page_6");
            Component text_7 = Component.translatable("adventurer_manuscript.entity.boa.page_7");
    ...
    public static class CrocodileChapter extends OWChapter {
        public static void render(int x, int y, float scale, float alpha, int page) {
            Component text_1 = Component.translatable("adventurer_manuscript.entity.crocodile.page_1");
            Component text_2 = Component.translatable("adventurer_manuscript.entity.crocodile.page_2");
            Component text_3 = Component.translatable("adventurer_manuscript.entity.crocodile.page_3");
            Component text_4 = Component.translatable("adventurer_manuscript.entity.crocodile.page_4");
            Component text_5 = Component.translatable("adventurer_manuscript.entity.crocodile.page_5");
            Component text_6 = Component.translatable("adventurer_manuscript.entity.crocodile.page_6");
