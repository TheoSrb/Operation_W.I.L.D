...
@OnlyIn(Dist.CLIENT)
public class KangarooSkinsScreen extends OWSkinsInterface {

    private Button skinButton1;
    private Button skinButton2;

    private final int numberOfSkins = 2;

    public KangarooSkinsScreen() { super(); }
    ...
    protected SkinInfo getSkinInfo(int skinIndex) {
        return switch (skinIndex) {
            case 1 -> SkinInfo.level("tooltip.kangarooSkin1", "tooltip.kangarooSkin1.desc", 50);
            case 2 -> SkinInfo.free("tooltip.kangarooSkin2", "tooltip.kangarooSkin2.desc");
            default -> null;
        };
    }
    ...
    protected void initEntityScale() {
        if (this.entity != null && "KangarooEntity".equals(this.entity.getClass().getSimpleName())) {
    ...
    protected void createAndAddButtons() {
        ...
        skinButton1 = createSkinButton(Component.translatable("tooltip.kangarooSkin1"), 1, LEGENDARY_SKIN);
        skinButton2 = createSkinButton(Component.translatable("tooltip.kangarooSkin2"), 2, COMMON_SKIN);
    ...
    protected void addTooltipsToButtons() {
        if (isLocked(1)) skinButton1.setTooltip(Tooltip.create(Component.translatable("tooltip.kangarooSkin1Indication")));
    }
