...
@OnlyIn(Dist.CLIENT)
public class PeacockSkinsScreen extends OWSkinsInterface {
    ...
    public PeacockSkinsScreen() {
        super();
    }

    @Override
    protected void initEntityScale() {
        if (this.entity != null && "PeacockEntity".equals(this.entity.getClass().getSimpleName())) {
    ...
    protected void createAndAddButtons() {
        ...
        skinButton1 = createSkinButton(Component.translatable("tooltip.peacockSkin1"), 1, LEGENDARY_SKIN);
        skinButton2 = createSkinButton(Component.translatable("tooltip.peacockSkin2"), 2, RARE_SKIN);
        skinButton7 = createSkinButton(Component.translatable("tooltip.peacockSkin7"), 7, COMMON_SKIN);
    ...
    protected void addTooltipsToButtons() {
        if (isLocked(1)) skinButton1.setTooltip(Tooltip.create(Component.translatable("tooltip.peacockSkin1Indication")));
    }
