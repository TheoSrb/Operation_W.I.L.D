...
public class OWTeam {
    ...
    private int teamSecondaryColor;   // ← nouveau
    private OWTeamMosaicPattern teamMosaicPattern;  // ← nouveau
    ...
    public OWTeam(int teamId, String teamName, UUID teamOwnerUUID, int teamColor,
        ...
        this(teamId, teamName, teamOwnerUUID, teamColor, 0xFFFFFF, OWTeamMosaicPattern.GRADIENT_DOWN,
                teamMembers, teamEntitiesMembers, teamCreationDate, playerNames, entityNames);
    }
