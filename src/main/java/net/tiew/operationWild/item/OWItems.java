...
public class OWItems {
    ...
    public static final DeferredHolder<Item, Item> KODIAK_SADDLE = ITEMS.register("kodiak_saddle", () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredHolder<Item, Item> CROCODILE_SADDLE = ITEMS.register("crocodile_saddle", () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredHolder<Item, Item> ORCA_SADDLE = ITEMS.register("orca_saddle", () -> new Item(new Item.Properties().stacksTo(1)));

    public static final DeferredHolder<Item, Item> BOXING_GLOVES = ITEMS.register("boxing_gloves", () -> new Item(new Item.Properties().stacksTo(1)));
    ...
    public static final DeferredHolder<Item, Item> ORCA_SPAWN_EGG = ITEMS.register("orca_spawn_egg",
            () -> new DeferredSpawnEggItem(OWEntityRegistry.ORCA, 0x28313e, 0xdae2e5, new Item.Properties()));
    public static final DeferredHolder<Item, Item> BOA_SPAWN_EGG = ITEMS.register("boa_spawn_egg",
            () -> new DeferredSpawnEggItem(OWEntityRegistry.BOA, 0x566022, 0x363117, new Item.Properties()));
    public static final DeferredHolder<Item, Item> ELEPHANT_SPAWN_EGG = ITEMS.register("elephant_spawn_egg",
            () -> new DeferredSpawnEggItem(OWEntityRegistry.ELEPHANT, 0x827570, 0x6b5c57, new Item.Properties()));
    public static final DeferredHolder<Item, Item> RED_PANDA_SPAWN_EGG = ITEMS.register("red_panda_spawn_egg",
            () -> new DeferredSpawnEggItem(OWEntityRegistry.RED_PANDA, 0xd15d2a, 0xec8925, new Item.Properties()));
