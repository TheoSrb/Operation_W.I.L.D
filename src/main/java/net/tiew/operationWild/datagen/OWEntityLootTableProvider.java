...
public class OWEntityLootTableProvider extends EntityLootSubProvider {
    ...
    public void generate() {
        ...
        this.add(OWEntityRegistry.ORCA.get(), LootTable.lootTable()
                .withPool(createBasicPool(OWItems.CROCODILE_SCALE.get(), 1.0F, 2.0F, true))
        );
        ...
        this.add(OWEntityRegistry.BOA.get(), LootTable.lootTable()
                ...
                .withPool(createRarePool(OWItems.VENOMOUS_TOOTH.get(), 0.35F, 1, false))
                .withPool(createRarePool(OWItems.BOA_TONG.get(), 0.5F, 1, false))
        );

        this.add(OWEntityRegistry.KANGAROO.get(), LootTable.lootTable()
                .withPool(createBasicPool(OWItems.CROCODILE_SCALE.get(), 1.0F, 2.0F, true))
        );
